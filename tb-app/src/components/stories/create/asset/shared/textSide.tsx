...
export default function TextSide({selected,setSelected,textStory,setTextStory,setStory,story,photoStory,choice}:{
    selected:{
        bgColor:string;
    ...
    return (
        <div className="flex flex-col gap-3 p-2 relative flex-1">
            <div className="flex-1 flex gap-2 flex-col">
                ...
                {story=="text"&&<div className="rounded-md border-black/30 border p-3">
            ...
            {discard&&<OverlayTemplate title="Discard story?" setShow={setDiscard}>
