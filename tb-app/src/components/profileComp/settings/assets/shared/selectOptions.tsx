...
export default function SelectOptions({chosed,setChosen,desc,name,value,icon}:{
    ...
    return (
        <div className="p-2 flex items-center hover:bg-gray-300/40 rounded-md transition-all duration-300 cursor-pointer gap-1 justify-between" onClick={() => setChosen(value)} role="radio">
