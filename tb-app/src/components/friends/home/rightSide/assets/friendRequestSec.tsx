    ...
    return (
        <section className="flex gap-3 flex-col border-b pb-8 border-black/20">
            <div className="flex justify-between items-center">
                <h1 className="text-xl md:text-2xl font-bold">Friends Requests</h1>
                <Link href={"/friends/requests"} className="text-base  md:text-lg text-blue-500 p-2 rounded-md hover:bg-gray-300/40 transition-all duration-300 active:scale-95">
                    See all
                </Link>
            </div>
